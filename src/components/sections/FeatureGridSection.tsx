...
const features = [
    ...
    {
        title: "Auto-QA",
        description: "Every conversation scored. Tone, accuracy, policy compliance. You stop reading transcripts.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        description: "Your AI remembers that Sarah prefers email and hates hold music. Next time she calls, it acts on that.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
