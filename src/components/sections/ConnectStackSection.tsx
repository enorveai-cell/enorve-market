                ...
                <div className="relative mx-auto max-w-4xl animate-fade-in-up delay-200">
                    ...
                    <div className="relative mt-8 h-64 pointer-events-none">
                        <svg viewBox="0 0 900 360" className="absolute inset-0 w-full h-full" fill="none">
                            ...
                            <path d="M450 300 C 450 180, 660 100, 810 30" stroke="url(#enorve-line-gradient)" strokeWidth="1" strokeLinecap="round" fill="none" style={{ strokeDasharray: 650, strokeDashoffset: 650 }}>
                                <animate attributeName="stroke-dashoffset" values="650;0;650" dur="4s" begin="1.2s" repeatCount="indefinite" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1"></animate>
                            </path>
                            <path d="M450 300 C 450 200, 240 100, 90 30" stroke="url(#enorve-line-gradient)" strokeWidth="1" strokeLinecap="round" fill="none" style={{ strokeDasharray: 650, strokeDashoffset: 650 }}>
                                <animate attributeName="stroke-dashoffset" values="650;0;650" dur="4s" begin="1.4s" repeatCount="indefinite" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1"></animate>
                            </path>
                        </svg>
